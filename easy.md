...
Вконтакте довольно популярная соцсеть, однако и она не лишена недостатков. Давайте начнем с них:

-   **Вас смогут найти в списке подписчиков группы, события** (Даже если ваш аккаунт закрытый)
...
Этот месенджер так же не рекомендуется к использованию, без везких причин. Тем не менее заходим в настройки:
