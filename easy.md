## 3.1 Настройки безопасности Telegram
...
1. Активные сеансы
    ...
    При всем этом нужно понимать, что контакт абьюзера и людей, которые могут подвергнуться его влиянию, должны быть УДАЛЕНЫ из контактов Telegram.

## 3.2 Настройки безопасности VK
...
1. Безопасность
    ...
    - Оставляем только сеансы на устройствах, которые контроллируем
1. Приватность
...
## 3.3 Настройки безопасности WhatsApp
...
## 3.4 Настройки безопасности Viber
...
## 3.5 Настройки безопасности Facebook Messenger

Нажимаем на свою аватарку в левом верхнем углу:
...
## 3.6 Настройки безопасности Facebook

Нажимаем на стрелочку в верхнем, правом углу, настройки и конфедециальность, настройки:
...
1. Безопасность и вход
    ...
    - Зашифрованные электронные письма с уведомлениями - по желанию можно давить этот дополнительные уровень защиты. Суть состоит в том, что расшифровать уведомления от Facebook сможете только вы, использовав ключ. Инструкция лежил на самом сайте.
...
## 3.7. Настройки безопасности Instagram и безопасное использование
...
## 5. Банковская карта и безопасность
...
1.  Придумывайте хорошие пароли и используйте их
    ...
    Так же существует способ собрать пароль из строки. Это может быть хорошо запоминающаяся поговорка или ваша любимая песня. К примеру возьмем отрывок песни Old Town Road:

    _Yeah, I'm gonna take my horse to the old town road_ \
    _I'm gonna ride 'til I can't no more_

        1. Берем первую букву из каждого слова: `YIGTMHTTOTRIGRTICNM

        2. Чередуем строчные и заглавные буквы: YiGtMhTtOtRiGrTiCnM

        3. Для уверенности добавляем в конце случайный набор цифр, так, чтобы его было легко вспомнить YiGtMhTtOtRiGrTiCnM2281337
...
## 8. Вебкамера. Что делать, если кажется, что за тобой следят
...
- Панель управления (можно открыть с помощью сочетания клавиш win+R,
    в открывшемся окне набрать control и нажать Enter, либо с помощью поиска меню Пуск в Windows 10)
...
### 8.1. Бесплатные антивирусы можно найти здесь:
...
Если вы разорвали опасные отношения и боитесь преследования, мы рекомендуем вам максимально "обновиться" в информаионном пространстве. 
А именно:
...
## 10. Безопасность в браузерах

Мы рекомендуем установить расширения:
- Canvas Defender
- No script
TODO: дальше
...
Первое может быть нужным нам если мы заходим на сайты или сервера злоумышленника. Второе нужно если мы сидим в публичной сети или WiFi. Однако, в целом, использовать VPN считается хорошим тоном, если вам нужно сохранить инкогнито в интернете. Не всегда сайты зашифрованны или от надежных источников и мы просто можем забыть включить VPN! Поэтому хорошим правилом будет постоянно его держать включенным.

Так как его выбрать? Мысленно можно определить четыре типа VPN
 
 1. Платные
 1. Бесплатные, быстрые, но сомнительного качества
 1. Собственный сервер
 1. Бесплатные, надежные и медленные

### Быстрые и платные

Да, типичный треугольник Качество-Цена-Скорость. Давайте начнем с обзора быстрых и платных. Их очень много) Кратко - выбирайте по вкусу и доверию.
...
Самое важное что стоит запомнить - если вы не платите за товар, то товар это вы. Но для наших целей сойдет, просто не стоит через эти VPN совершать что-то противозаконное. Хотя ваши данные вполне могут оказаться на черном рынке. Давайте посмотрим интересные варианты:
...
Самый известный такой VPN - это Tor. Он надежный, бесплатный, безлимитный, но медленный. Иногда очень медленный. Его используют преступники для покупки запрещенного товара и доступа к теневому интернету, так что его надежности вам хватит. Можно использовать его, если у вас стальные нервы.

### Собственный сервер

Самый легкий способ поднять свой VPN это Outline - проект дочерней компании Google.

Подробная и понятная инструкция для людей [есть на habr](https://habr.com/ru/post/358828/). В несколько кликов и за 15 минут, а не за неделю изучение bash.
