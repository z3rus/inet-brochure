...
- В Сбербанк Онлайн рекомендуем выставить такие настройки безопасности:
    ...
    - Вход по Fingerprint - отключить
    - Инкогнито - включить
    - Скрыть содержание экрана - включить
    - Скрыть ленту уведомлений до входа в приложение - включить
...
Отключить устройства в Windows:
    ...
    "Звуковые, игровые и видеоустройства", найти среди них свою вебкамеру и микрофон (обычно отмечены понятными значками),
    нажать на них правой кнопкой мыши и выбрать пункт "Отключить устройство"
