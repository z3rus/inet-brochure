...
- Никому не сообщайте CCV код на обратной стороне карты, ПИН-код карты, а также коды из СМС, которые приходят их банка (кроме случаев, когда осознанно совершаете оплату на сайте)
